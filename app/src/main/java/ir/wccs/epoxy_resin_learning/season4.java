...
public class season4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button s1n14 = (Button) findViewById(R.id.btns1n14);
        final Button s1n15 = (Button) findViewById(R.id.btns1n15);
        final Button s1n16 = (Button) findViewById(R.id.btns1n16);
        final Button s1n17 = (Button) findViewById(R.id.btns1n17);
        final Button s1n18 = (Button) findViewById(R.id.btns1n18);
        final Button s1n19 = (Button) findViewById(R.id.btns1n19);
        final Button s1n20 = (Button) findViewById(R.id.btns1n20);
        final Button s1n21 = (Button) findViewById(R.id.btns1n21);
        final Button s1n22 = (Button) findViewById(R.id.btns1n22);
        final Button s1n23 = (Button) findViewById(R.id.btns1n23);
        final Button s1n24 = (Button) findViewById(R.id.btns1n24);
        final Button s1n25 = (Button) findViewById(R.id.btns1n25);
        final Button s1n26 = (Button) findViewById(R.id.btns1n26);
        final Button s1n27 = (Button) findViewById(R.id.btns1n27);
        final Button s1n28 = (Button) findViewById(R.id.btns1n28);
        final Button s1n29 = (Button) findViewById(R.id.btns1n29);
        final Button s1n30 = (Button) findViewById(R.id.btns1n30);
        final Button s1n31 = (Button) findViewById(R.id.btns1n31);
        final Button s1n32 = (Button) findViewById(R.id.btns1n32);
        final Button s1n33 = (Button) findViewById(R.id.btns1n33);
