...
public class s5n1p1_1 extends AppCompatActivity {
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("https://aspb3.cdn.asset.aparat.com/aparat-video/7941ec8c188ac40f6be51feaf6107b1217160289-720p.mp4");
        } else {
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                Toast.makeText(s5n1p1_1.this,"ویدئوی شما در حال بارگزاری میباشد ...", Toast.LENGTH_SHORT).show();
